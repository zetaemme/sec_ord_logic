    ...
    \section{Introduction}
        ...
        \subsection{A recall on first-order logic}
            ...
            \subsubsection{Semantics}
                ...
                \begin{frame}
                    \frametitle{Semantics - Evaluation (1)}
                    \begin{itemize}
                ...
                \begin{frame}
                    \frametitle{Semantics - Evaluation (2)}
                    \begin{enumerate}
                        \item Extend $ \overline{a} $ to all terms of the language with the following rules:
                            \begin{itemize}
                                ...
                                \item Given $ \{ t_1, \dots, t_n \} \in \texttt{TERM} $ evaluated to $ \{ d_1, \dots, d_n \} $, a function $ f(t_1, \dots, t_n) $ evaluates to $ I(f)(d_1, \dots, d_n) $ 
                            \end{itemize}
                ...
                \begin{frame}
                    \frametitle{Semantics - Evaluation (3)}
                    \begin{itemize}
                        \item An \textit{atomic formula} $ P(t_1, \dots, t_n) $ is associated with a \textit{truth value}, depending on the truth of the following:
                            \[
                                \langle v_1, \dots, v_n \rangle \in I(P)   
                            \]
                ...
                \begin{frame}
                    \frametitle{Semantics - Evaluation (4)}
                    \begin{itemize}
