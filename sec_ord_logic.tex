    ...
    \section{Introduction}
        ...
        \section{Second-Order Logic}
                ...
                \begin{frame}
                    ...
                    \begin{proofidea}
                        ...
                        \begin{prooftree}
                            ...
                            \RightLabel{$ \exists^2I $}
                            \UnaryInfC{$ \exists X^n. \forall t_1, \dots, t_n.(\phi(t_1, \dots, t_n) \Leftrightarrow X^n(t_1, \dots, t_n)) $}
                        \end{prooftree}
                    \end{proofidea}
                    \begin{itemize}
            ...
            \subsection{Soundness and Completeness}
                ...
                \begin{frame}
                    % TODO Consider to skip this part
                    \frametitle{TODO}
                    \begin{itemize}
            ...
            \subsection{Identity}
                ...
                \begin{frame}
                    ...
                    \begin{proofidea}[Proof idea of $ I_{\,1}, I_{\,2}, I_{\,3}, I_{\,4} $]
                        $  I_{\,1},  I_{\,2} $ and $  I_{\,3} $ are obvious, since they states \textit{identity}, \textit{commutativity} and \textit{transitivity}.\\
                        Since we can derive $ (x = y) $, if the \textbf{LHS} makes a generic \textit{formula} $ \phi $ \texttt{true}, then \textbf{RHS} will make that same \textit{formula} \texttt{true}. If we cannot derive $ (x = y) $ the implication is obviously \texttt{true}.
                    \end{proofidea}
                    \begin{proof}
                        \begin{itemize}
