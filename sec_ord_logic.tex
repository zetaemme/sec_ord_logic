        ...
        \section{Second-Order Logic}
            ...
            \subsection{Flattening SOL}
                ...
                \begin{frame}
                    ...
                    \end{itemize}
                    \begin{corollary}
                        Given a formula $ \phi $, $ \vdash \phi \Rightarrow\; \vdash_2 \phi $ since we never added a $ \bot I $ derivation in extending FOL \textit{Natural Deduction}, so $ \cancel{\vdash_2}\, \bot $
                    \end{corollary}
                \end{frame}
                ...
                \begin{frame}
                    ...
                    \begin{proofidea}
                        ...
                        If $ \Gamma $ is formed by any \textit{Second-Order formula}, we can say that $ \Gamma \vDash_2 \phi $ since we can find a derivation\footnote{With a little \textit{abuse of notation} we use $ \Pi $ to represent any subtree that can be used to derive $ \phi $}
                        \begin{prooftree}
                            \AxiomC{$ \Pi $}
                            \UnaryInfC{$ \phi $}
                        \end{prooftree}
